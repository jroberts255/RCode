...
pbp11rc[1:5, c("GAME_ID", "EVENT_ID", "c00", 'c10', "c20", "c11", "c01",
               "c30", "c21", "c31", "c02", "c12", "c22", "c32", "RUNS.VALUE")]
...
miggy00 <- subset(carbera, bscount=="0-0")
miggyloess <- loess(swung ~ px + px, data=miggy00, control = loess.control(surface="direct"))
